    ...
    <div>
        <nav v-if="currentUser" class="navbar navbar-expand navbar-dark bg-dark">
            <div class="navbar-nav">
                ...
                <router-link v-if="isAdmin" to="/client" class="nav-item nav-link">Clients</router-link>
                <router-link v-if="isUser" to="/project" class="nav-item nav-link">Project</router-link>
