<template>
    <div>
        ...
        <router-link to="/addpro"><button type="button" @click="info(currentUserValue.id)" class="btn btn-primary">Add Project</button></router-link>
    <table class="table table-striped">
        ...
        <tbody>
            <tr v-for="u in projects">
                ...
                <td>
                   <button type ="button" @click="editPro(u.id,u.users_id,u.projectTitle,u.projectDescription,u.projectdeadline,u.projectStatus)" class="btn btn-light mr-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
...
export default {
    ...
    methods: {
        ...
        editPro(id,uid,title,desc,dead,status){
...
del(id){
    ...
    created () {
        userService.getProjects(this.user.id).then(projects => this.projects = projects);
    }
};
</script>